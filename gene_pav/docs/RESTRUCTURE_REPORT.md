...
├── detect_one2many_mappings.py          # Core module - 1:N detection
├── pariwise_align_prot.py               # Core module - protein alignment
...
| `*_ref_to_multiple_query.tsv` | `detect_one2many_mappings.py` | pavprot output | 1:N mappings |
| `*_query_to_multiple_ref.tsv` | `detect_one2many_mappings.py` | pavprot output | N:1 mappings |
| `*_multiple_mappings_summary.txt` | `detect_one2many_mappings.py` | pavprot output | Statistics summary |

### Scenario Output Files

| Scenario File | Generated By | Description |
|---------------|--------------|-------------|
| `scenario_E_1to1_orthologs.tsv` | `detect_advanced_scenarios.py` | True 1:1 orthologs |
| `scenario_A_1toN_mappings.tsv` | `detect_advanced_scenarios.py` | One ref → multiple queries |
| `scenario_B_Nto1_mappings.tsv` | `detect_advanced_scenarios.py` | Multiple refs → one query |
| `scenario_J_complex_1toN_mappings.tsv` | `detect_advanced_scenarios.py` | One ref → 3+ queries |
| `scenario_CDI_cross_mappings.tsv` | `detect_advanced_scenarios.py` | Cross-mapping groups |
| `scenario_F_positional_swaps.tsv` | `detect_advanced_scenarios.py` | Adjacent gene order inversions |
| `scenario_G_unmapped_ref_genes.tsv` | `detect_advanced_scenarios.py` | Ref genes without query matches |
| `scenario_H_unmapped_query_genes.tsv` | `detect_advanced_scenarios.py` | Query genes without ref matches |
| `detection_summary.txt` | `detect_advanced_scenarios.py` | Scenario counts summary |
